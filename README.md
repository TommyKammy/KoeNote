...
- 下部のスリム音声プレイヤーでは、再生・停止、前後セグメント移動、波形シーク、音量、再生速度を操作できます。
...
標準レイアウト下部のスリム再生バーでは、音声ファイル名、再生位置、前後セグメントへの移動、再生・停止、波形シーク、音量、再生速度を操作できます。詳細レイアウトでは、従来相当の高さを持つ再生バーで同じ操作ができます。最下部のステータスバーには、保存先、初回チェック、空き容量、メモリ、CPU、GPU の状態が表示されます。
