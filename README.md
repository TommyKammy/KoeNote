...
KoeNote は、作業の中心になる B 案の標準レイアウトで起動します。標準レイアウトは、左のジョブレール、中央の文書エリア、右の AI 支援レール、下部のスリム音声プレイヤーで構成されています。
...
- 右の AI 支援レールでは、整文候補の確認と要約の生成・再生成を行います。
...
- 詳細: C 案の詳細レイアウトを開き、整文、素起こし、差分、レビュー候補をタブで確認します。
...
詳細レイアウトは、従来相当の確認・編集操作を広く並べた C 案の画面です。標準レイアウトの `詳細` から切り替えられ、選択中のジョブとタブ状態を保ったまま開きます。
