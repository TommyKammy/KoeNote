...
- エクスポート: 素起こし、整文、要約を TXT / Markdown / JSON / SRT / VTT / DOCX などの形式で出力します。
- ズーム: 画面中央の表示倍率を調整します。
...
必要に応じて、エクスポートメニューでタイムスタンプを含めるかどうかも切り替えられます。字幕用途では SRT / VTT、文章として確認・共有する場合は TXT / Markdown / DOCX が便利です。
