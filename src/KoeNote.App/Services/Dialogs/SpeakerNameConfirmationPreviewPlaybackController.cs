...
public sealed class SpeakerNameConfirmationPreviewPlaybackController(IAudioPlaybackService audioPlaybackService)
{
    ...
    private static double GetPreviewEndSeconds(SpeakerNameConfirmationPreview preview)
    {
        var startSeconds = SanitizeSeconds(preview.StartSeconds);
